...
-- Can't think of an elegant way to do diagonals
winnow row col = map (drop col) . take n $ drop row ll
zip4x4 row col ixs = zipWith ($) (map (drop) ixs) (winnow row col)
